...
const ChatLabel = ({openMenu,setOpenMenu}) => {
  return (
      <div className='flex items-center justify-between p-2 text-black/80 hover:bg-black/10  rounded-lg text-sm group cursor-pointer'>
          ...
          <div className='group relative flex items-center justify-center h-6 w-6 aspect-square hover:bg-black/80 rounded-lg'>
              ...
              <div className={`absolute -right-36 top-6 bg-gray-700 text-white rounded-xl w-max p-2 ${openMenu.open ? 'block' : 'hidden'}`}>
                  <div className='flex items-center gap-3 hover:bg-white/10 px-3 py-2 rounded-lg text-white/60'>
